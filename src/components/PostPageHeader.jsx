...
import { AppBar, Box, Container, Grid, IconButton, InputAdornment, TextField, Input, Toolbar, Typography } from '@mui/material'

const PostPageHeader = ({handleOpen}) => {
            ...
            <Container>
                <Toolbar>
                    <Typography sx={{flex:1}}>
                        <img src="assets/homePage/logo.png" width="35%" style={{ marginTop: 15 }} />
                    </Typography>
                    <Box sx={{flex:1}}>
                        <Input sx={{backgroundColor:"#efefef",paddingX:"10px",paddingY:"3px",borderRadius:"5px"}} disableUnderline  startAdornment ={
                    ...
                    <Box sx={{flex:1}}>
                        ...
                        <IconButton>
                            <img style={{borderRadius:"50%",outline:"1px solid #ddd"}} src="assets/dp.jpg" width="40px" height="40px" alt="" />
                        </IconButton>
                    </Box>
                </Toolbar>
            </Container>
